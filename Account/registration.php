        ...
        <div class="row">
            ...
            <div class="form-holder" >
                ...
                <div class="form-content" style="max-height: unset;">
                  ...
                  <span  class="text-dark" style="font-size:1.2rem">Man-able..</span>
                            ...
                            <form method="post" id="regForm" class="form form-horizontal" novalidate autocomplete="off" action="">
                                <div class="form-body">
                                    ...
                                    <div class="row d-flex flex-wrap">
                                        ...
                                        <p class="fw-100" style="font-size:.7rem">or click<a href="Login.php"> here to login</a> if you have an account</p>
                                    </div>
                                </div>
                            </form>
                        </div>
