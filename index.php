    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark nav-light">
        <div class="container">
            ...
            <a class="navbar-brand logo" href="index.html">
                ...
                <span  class="logo-dark text-dark" >Man-able..</span>
                <span class="logo-light text-light" style="font-size:2rem">Man-able..</span>
            </a>
                ...
                <div class="hero-title">
                    <h1 class="hero-7-title">
                        <span class="text-wrapper">
                            <span class="text-light font-weight-normal">Employee Management System </span>                        
                        </span>                    </h1>
                    <q class="text-light-70 mb-4 pb-2">
